...
public class UsersApiTests
{
    ...
    public async Task GetUsers_Returns_Pagination_Metadata()
    {
        ...
        var admin = await TestUserFixture.RegisterAndLoginAsAdminAsync(client);
        client.DefaultRequestHeaders.Authorization = new System.Net.Http.Headers.AuthenticationHeaderValue("Bearer", admin.Token);
