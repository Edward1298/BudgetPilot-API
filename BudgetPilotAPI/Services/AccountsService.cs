...
public class AccountsService
{
    ...
    public async Task<AccountsOBJ> CreateAccount(AccountsDTO dto, Guid userId)
    {
        ...
        var account = new AccountsOBJ
        {
            ...
            Type = dto.Type,
            Balance = dto.Balance,
            InterestRate = dto.Type != "savingsAccount" ? null : dto.InterestRate,
    ...
    public async Task<AccountsOBJ?> UpdateAccount(Guid id, AccountUpdateDTO dto, Guid userId)
    {
        ...
        var resolvedType = dto.Type ?? account.Type;
        if (resolvedType != "savingsAccount")
    ...
    /// <summary>
    /// Reactivates an inactive account. Returns whether the account was found
    ...
    /// <summary>
    /// Retrieves all accounts for a specific user, optionally filtered by active status.
