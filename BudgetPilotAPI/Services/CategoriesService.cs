...
public class CategoriesService
{
    ...
    /// <summary>
    /// Retrieves all categories for a specific user, optionally filtered by active status.
    ...
    /// <summary>
    /// Retrieves a paginated list of inactive categories belonging to the specified user.
    /// </summary>
    ...
    /// <summary>
    /// Reactivates an inactive category. Returns whether the category was found
    /// and whether it was already active.
    /// </summary>
    public async Task<(bool Found, bool AlreadyActive)> ReactivateCategory(Guid id)
    {
        var category = await _context.Categories
